...
const handleSendMessage = async (e) => {
  ...
  if (selectedContact && message.trim()) {
      ...
      // Clear the message input and emoji picker state after sending the message
      setMessage("");
  ...
  return (
    ...
    <div className={`grid place-items-center h-screen ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}
      style={{
    ...
    // <div>
    //   <h2  className="text-center">Welcome to the Chat Page</h2>
    // </div>
