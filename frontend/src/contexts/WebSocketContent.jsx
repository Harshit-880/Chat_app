...
const register = async (username, password) => {
  ...
  return (
    <WebSocketContext.Provider value={{ register,messages,sendMessage,login, logout,username ,contacts,unreadCounts,setUnreadCounts,onlineStatus,setOnlineStatus}}>
      {children}
